...
class _Courses2ScreenState extends State<Courses2Screen> {
  ...
  var model;
  var uId;
  CollectionReference courses2 = FirebaseFirestore.instance.collection("courses2");
          ...
          children: [
            Container(
              ...
              child: Column(
                children: const [
                  Center(
                    child: Text('الفرقة الثانية',style: TextStyle(
                      color: Colors.black,
                ...
                if (snapshot.hasData) {
                  return ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        return InkWell(
                          onTap: () async {
                            CollectionReference codes = FirebaseFirestore.instance.collection("courses2").doc(
